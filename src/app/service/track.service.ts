...
export class TrackService {
  ...
  getItaly(): Observable<any>
  {
    return this.http.get("http://ws.audioscrobbler.com/2.0/?method=geo.gettoptracks&country=italy&api_key=f6461f6889c8f2b1a0994c70929277fc&format=json");
  }
  getFrance(): Observable<any>
  {
    return this.http.get("http://ws.audioscrobbler.com/2.0/?method=geo.gettoptracks&country=france&api_key=f6461f6889c8f2b1a0994c70929277fc&format=json");
  }
  getSweden(): Observable<any>
  {
    return this.http.get("http://ws.audioscrobbler.com/2.0/?method=geo.gettoptracks&country=sweden&api_key=f6461f6889c8f2b1a0994c70929277fc&format=json");
  }
